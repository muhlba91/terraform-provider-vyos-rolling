...
import (
	...
	// Extra Imports
	"github.com/echowings/terraform-provider-vyos-rolling/internal/terraform/resource/autogen/named/interfaces/macsec-dhcpv6-options-pd-interface/resourcemodel"
)
