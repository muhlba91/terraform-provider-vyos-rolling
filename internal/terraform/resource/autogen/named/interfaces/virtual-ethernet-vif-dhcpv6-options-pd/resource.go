...
import (
	...
	// Extra Imports
	"github.com/echowings/terraform-provider-vyos-rolling/internal/terraform/resource/autogen/named/interfaces/virtual-ethernet-vif-dhcpv6-options-pd/resourcemodel"
)
