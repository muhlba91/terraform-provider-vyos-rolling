...
import (
	...
	// Extra Imports
	"github.com/echowings/terraform-provider-vyos-rolling/internal/terraform/resource/autogen/named/interfaces/bridge-vif-dhcpv6-options-pd-interface/resourcemodel"
)
