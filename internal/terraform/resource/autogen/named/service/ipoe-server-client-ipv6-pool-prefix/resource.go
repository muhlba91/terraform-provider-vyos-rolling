...
import (
	...
	// Extra Imports
	"github.com/echowings/terraform-provider-vyos-rolling/internal/terraform/resource/autogen/named/service/ipoe-server-client-ipv6-pool-prefix/resourcemodel"
)
