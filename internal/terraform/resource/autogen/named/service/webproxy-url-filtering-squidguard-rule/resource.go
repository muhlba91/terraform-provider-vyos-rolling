...
import (
	...
	// Extra Imports
	"github.com/echowings/terraform-provider-vyos-rolling/internal/terraform/resource/autogen/named/service/webproxy-url-filtering-squidguard-rule/resourcemodel"
)
