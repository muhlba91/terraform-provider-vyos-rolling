...
import (
	...
	// Extra Imports
	"github.com/echowings/terraform-provider-vyos-rolling/internal/terraform/resource/autogen/named/vpn/ipsec-remote-access-connection-authentication-local-users-username/resourcemodel"
)
