...
import (
	...
	// Extra Imports
	"github.com/echowings/terraform-provider-vyos-rolling/internal/terraform/resource/autogen/global/protocols/isis-default-information-originate-ipv4-level-1/resourcemodel"
)
