...
import (
	...
	// Extra Imports
	"github.com/echowings/terraform-provider-vyos-rolling/internal/terraform/resource/autogen/global/protocols/isis-fast-reroute-lfa-local-load-sharing-disable/resourcemodel"
)
