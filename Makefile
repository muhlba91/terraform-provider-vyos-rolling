...
internal/terraform/resource/autogen/package.go: \
	...
	# Re-apply any manual overrides that must live alongside autogenerated code
	if [ -d "../../internal/terraform/resource/overrides" ]; then \
		if command -v rsync >/dev/null 2>&1; then \
			rsync -a --exclude 'go.mod' --exclude 'go.sum' "../../internal/terraform/resource/overrides/" "../../internal/terraform/resource/autogen/"; \
		else \
			cp -a "../../internal/terraform/resource/overrides/." "../../internal/terraform/resource/autogen/"; \
		fi; \
		rm -f "../../internal/terraform/resource/autogen/go.mod" "../../internal/terraform/resource/autogen/go.sum"; \
	fi
